...
<img src="./img/console//1568169770714.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169796122.png"/>
</div>
​       点击记录，可以看到选中的消费组里的消费者成员，及对应消费的Broker及Partition分区信息，如下图示：

<div style="text-align:center">
<img src="./img/console//1568169806810.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169823675.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169839931.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169851085.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169879529.png"/>
</div>

​       我们通过如上图中的Topic列表项完成Topic的新增，会弹出如下框，

<div style="text-align:center">
<img src="./img/console//1568169889594.png"/>
</div>

​       点击确认后会有一个选择部署该新增Topic的Broker列表，选择部署范围后进行确认操作：

<div style="text-align:center">
<img src="./img/console//1568169900634.png"/>
</div>

​       在完成新增Topic的操作后，我们还需要对刚进行变更的配置对Broker进行重载操作，如下图示：

<div style="text-align:center">
<img src="./img/console//1568169908522.png"/>
</div>

​       重载完成后Topic才能对外使用，我们会发现如下配置变更部分在重启完成后已改变状态：

<div style="text-align:center">
<img src="./img/console//1568169916091.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169925657.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169946683.png"/>
</div>
...
<div style="text-align:center">
<img src="./img/console//1568169954746.png"/>
</div>
